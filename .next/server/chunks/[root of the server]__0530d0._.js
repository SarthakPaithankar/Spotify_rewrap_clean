...
(()=>{
    const e = new Error("Cannot find module './lib/route'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
;
...
handler.get(async (req, res)=>{
    try {
        ...
        const user = query('SELECT user FROM users WHERE username = $1', [
            username
        ]);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__0530d0._.js.map